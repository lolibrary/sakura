...
return [
    ...
    'item' => [
        ...
        'price' => 'Originally listed for <span class="text-regular">{{ $item->price_formatted }}</span>',
        'price_unknown' => 'No listing price recorded.',
        'submitter' => 'Submitted by <span class="text-regular">{{ $item->submitter->username }}</span>',
